...
Funcionalidades   | Comportamento Esperado | Verificações |  Critérios de Aceite  |
-----------|--------|--------|--------| 
| Autenticação e Autorização | ● Rotas protegidas devem exigir token válido. <br> ● Usuários só podem acessar seus próprios dados. | ● Token JWT válido requerido <br> ● Verificação de propriedade de recursos <br> ● Validação de permissões <br> ● Tratamento de tokens expirados | ● Acesso negado sem autenticação <br> ● Usuários isolados em seus dados |
